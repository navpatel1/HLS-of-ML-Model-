...
$(ObjDir)/vlsi_eval4_test_suite.c_pre.c.tb.o : vlsi_eval4_test_suite.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) vlsi_eval4_test_suite.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/vlsi_eval4.c_pre.c.tb.o : vlsi_eval4.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) vlsi_eval4.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
